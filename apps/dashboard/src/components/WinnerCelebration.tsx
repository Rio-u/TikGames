  ...
  return (
    <div className="relative flex flex-col items-center justify-center gap-6 text-center">
      ...
      >
        ...
        />
        <Trophy size={64} weight="fill" className="relative text-accent" />
      </motion.div>
      ...
      <motion.div
        ...
        className="rounded-3xl border border-accent/40 bg-gradient-to-br from-primary/20 to-accent/10 p-12"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.55 }} className="mt-5 text-base text-ink-muted">
          الفائز 🎉
        </motion.p>
        <motion.h3
        ...
        {subtitle && (
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }} className="mt-1 text-lg text-accent">
            {subtitle}
          </motion.p>
        )}
      </motion.div>
