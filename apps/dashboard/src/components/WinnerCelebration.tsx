  ...
  return (
    <div key={handle} className="relative flex w-full flex-col items-center justify-center">
      {/* Absolutely placed and non-interactive so it never pushes the card around or eats a
          click meant for the buttons underneath. Anchored to the top rather than filling the
          box: the scenes centre their number, and centring both put the card straight over it. */}
      <div className="pointer-events-none absolute inset-x-0 top-0 -z-0 min-h-[560px]">
      ...
      <motion.div
        ...
        className="relative z-10 mt-[300px] rounded-3xl border border-accent/40 bg-canvas-elevated/80 p-12 text-center shadow-glow backdrop-blur-2xl"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
