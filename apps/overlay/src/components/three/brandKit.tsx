 ...
 *
 * 1. **This runs inside OBS.** A Browser Source is a full Chromium compositing over a live encode,
 *    so every scene caps its DPR, keeps the light count fixed, and renders nothing at all once its
 *    moment has passed (see `Stage`'s `frameloop`). No post-processing passes, no shadow maps.
